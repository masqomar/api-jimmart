                    ...
                    <div class="col-xxl-5">
                        ...
                        <div class="text-center text-xxl-start">
                            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                                <div class="text-uppercase">Calculating &middot; Saving &middot; Gathering</div>
                            </div>
                            <div class="fs-3 fw-light text-muted">I can help you</div>
                            <h1 class="display-3 fw-bolder mb-5"><span class="text-gradient d-inline">Getting good financials</span></h1>
                            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3">
                                <a class="btn btn-primary btn-lg px-5 py-3 me-sm-3 fs-6 fw-bolder" href="http://www.app.kopkarjim.com">Login to Dashboard</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-7">
                        ...
                        <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                            <div class="profile bg-gradient-primary-to-secondary">
                                ...
                                <img class="profile-img" src="profile.png" alt="logo kopkar jim" />
                                <div class="dots-1">
                                    <!-- SVG Dots-->
